...
class ArgMaxMatcherTest(test_case.TestCase):
	...
	def test_return_correct_matches_with_default_thresholds(self):
		print('\n=============================================================')
		print('test_return_correct_matches_with_default_thresholds')
		...
		(res_matched_cols, res_unmatched_cols, res_match_results) \
				= self.execute(graph_fn, [similarity])

		print('res_matched_cols: {}'.format(res_matched_cols))
		print('res_unmatched_cols: {}'.format(res_unmatched_cols))
		print('res_match_results: \n{}'.format(res_match_results))
	...
	def test_return_correct_matches_unmatched_row_while_using_force_match(self):
		print('\n========================================================================')
		print('test_return_correct_matches_unmatched_row_while_using_force_match')
		def graph_fn(similarity):
			matcher = argmax_matcher.ArgMaxMatcher(matched_threshold=3.,
												   unmatched_threshold=2.,
...
if __name__ == '__main__':
	#tf.test.main()
	ArgMaxMatcherTest().test_return_correct_matches_with_default_thresholds()
	ArgMaxMatcherTest().test_return_correct_matches_unmatched_row_while_using_force_match()
