...
class ConvolutionalBoxPredictorTest(test_case.TestCase):
	...
	def test_get_boxes_for_five_aspect_ratios_per_location(self):
		print('\n================================================================')
		print('test_get_boxes_for_five_aspect_ratios_per_location')
	...
	def test_get_boxes_for_one_aspect_ratio_per_location(self):
		print('\n===========================================================')
		print('test_get_boxes_for_one_aspect_ratio_per_location')
	...
	def test_get_multi_class_predictions_for_five_aspect_ratios_per_location(self):
		print('\n=================================================================')
		print('test_get_multi_class_predictions_for_five_aspect_ratios_per_location')
	...
	def test_use_depthwise_convolution(self):
		print('\n====================================================================')
		print('test_use_depthwise_convolution')
		...
		with self.test_session() as sess:
			...
			(box_encodings_shape, objectness_predictions_shape) = sess.run(
					 [tf.shape(box_encodings), tf.shape(objectness_predictions)],
					 feed_dict={image_features: np.random.rand(4, resolution, resolution, 64)})
			actual_variable_set = set(
					[var.op.name for var in tf.trainable_variables()])
		self.assertAllEqual(box_encodings_shape, [4, expected_num_anchors, 1, 4])
		self.assertAllEqual(objectness_predictions_shape,
...
if __name__ == '__main__':
	#tf.test.main()
	ConvolutionalBoxPredictorTest().test_get_boxes_for_five_aspect_ratios_per_location()

	ConvolutionalBoxPredictorTest().test_get_boxes_for_one_aspect_ratio_per_location()

	ConvolutionalBoxPredictorTest().test_get_multi_class_predictions_for_five_aspect_ratios_per_location()
