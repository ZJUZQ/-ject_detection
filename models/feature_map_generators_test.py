...
class MultiResolutionFeatureMapGeneratorTest(tf.test.TestCase):
	...
	def test_get_expected_feature_map_shapes_with_inception_v2(self):
		print('\n===================================================================')
		print('test_get_expected_feature_map_shapes_with_inception_v2')
	...
	def test_get_expected_feature_map_shapes_with_embedded_ssd_mobilenet_v1(self):
		print('\n========================================================================')
		print('test_get_expected_feature_map_shapes_with_embedded_ssd_mobilenet_v1')

		image_features = {
				'Conv2d_11_pointwise': tf.random_uniform([4, 16, 16, 512], dtype=tf.float32),
...
class GetDepthFunctionTest(tf.test.TestCase):
	...
	def test_return_min_depth_when_multiplier_is_small(self):
		print('\n============================================================')
		print('test_return_min_depth_when_multiplier_is_small')
	...
	def test_return_correct_depth_with_multiplier(self):
		print('\n============================================================')
		print('test_return_correct_depth_with_multiplier')

		depth_fn = feature_map_generators.get_depth_fn(depth_multiplier=0.5,
													   min_depth=16)
		self.assertEqual(depth_fn(120), 60)


if __name__ == '__main__':
	#tf.test.main()
	GetDepthFunctionTest().test_return_min_depth_when_multiplier_is_small()
	GetDepthFunctionTest().test_return_correct_depth_with_multiplier()	

	FPNFeatureMapGeneratorTest().test_get_expected_feature_map_shapes()

	MultiResolutionFeatureMapGeneratorTest().test_get_expected_feature_map_shapes_with_inception_v2()
	MultiResolutionFeatureMapGeneratorTest().test_get_expected_feature_map_shapes_with_embedded_ssd_mobilenet_v1()
