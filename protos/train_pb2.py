...
_TRAINCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_multiclass_scores', full_name='protos.TrainConfig.use_multiclass_scores', index=19,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='add_regularization_loss', full_name='protos.TrainConfig.add_regularization_loss', index=20,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_number_of_boxes', full_name='protos.TrainConfig.max_number_of_boxes', index=21,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='unpad_groundtruth_tensors', full_name='protos.TrainConfig.unpad_groundtruth_tensors', index=22,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='retain_original_images', full_name='protos.TrainConfig.retain_original_images', index=23,
