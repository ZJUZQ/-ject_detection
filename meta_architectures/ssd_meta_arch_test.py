...
class MockAnchorGenerator2x2(anchor_generator.AnchorGenerator):
	...
	def _generate(self, feature_map_shape_list, im_height, im_width):
		return [box_list.BoxList(tf.constant([[0, 0, .5, .5],
											 [0, .5, .5, 1],
											 [.5, 0, 1, .5],
...
class SsdMetaArchTest(test_case.TestCase):
	...
	def test_preprocess_preserves_shapes_with_dynamic_input_image(self):
		print('\n===========================================================')
		print('test_preprocess_preserves_shapes_with_dynamic_input_image')
	...
	def test_preprocess_preserves_shape_with_static_input_image(self):
		print('\n===========================================================')
		print('test_preprocess_preserves_shape_with_static_input_image')
	...
	def test_predict_result_shapes_on_image_with_dynamic_shape(self):
		print('\n===========================================================')
		print('test_predict_result_shapes_on_image_with_dynamic_shape')
		...
		for input_shape in input_shapes:
			...
			with self.test_session(graph=tf_graph) as sess:
				...
				prediction_out = sess.run(prediction_dict, \
					feed_dict={preprocessed_input_placeholder: np.random.uniform(size=(batch_size, 2, 2, 3))})
	...
	def test_predict_result_shapes_on_image_with_static_shape(self):
		print('\n===========================================================')
		print('test_predict_result_shapes_on_image_with_static_shape')
	...
	def test_postprocess_results_are_correct(self):
		print('\n===========================================================')
		print('test_postprocess_results_are_correct')
		...
		for input_shape in input_shapes:
			...
			with self.test_session(graph=tf_graph) as sess:
				...
				detections_out = sess.run(detections,
										  feed_dict={input_placeholder: np.random.uniform(size=(batch_size, 2, 2, 3))})
	...
	def test_loss_results_are_correct_with_random_example_sampling(self):
		...
		print('{} {}'.format(num_classes, num_anchors))
...
if __name__ == '__main__':
	...
	SsdMetaArchTest().test_preprocess_preserves_shapes_with_dynamic_input_image()

	SsdMetaArchTest().test_preprocess_preserves_shape_with_static_input_image()

	SsdMetaArchTest().test_predict_result_shapes_on_image_with_dynamic_shape()

	SsdMetaArchTest().test_predict_result_shapes_on_image_with_static_shape()
