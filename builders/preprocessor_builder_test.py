...
class PreprocessorBuilderTest(tf.test.TestCase):
  ...
  def test_build_normalize_image(self):
    print('\n===========================================================')
    print('test_build_normalize_image')
    ...
    print('\nfunction: {}'.format(function.__name__))
    print('\nargs: {}'.format(args))
  ...
  def test_build_random_adjust_brightness(self):
    print('\n=======================================================')
    print('test_build_random_adjust_brightness')
...
if __name__ == '__main__':
  ...
  PreprocessorBuilderTest().test_build_normalize_image()
  PreprocessorBuilderTest().test_build_random_adjust_brightness()
