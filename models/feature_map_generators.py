...
def fpn_top_down_feature_maps(image_features, depth, scope=None):
	...
	Args:
		image_features: list of tuples of (tensor_name, image_feature_tensor).
			Spatial resolutions of succesive tensors must reduce exactly by a factor of 2.
	...
	with tf.name_scope(scope, 'top_down'):
		...
		with slim.arg_scope([slim.conv2d], padding='SAME', stride=1):
			...
			#return collections.OrderedDict(reversed(zip(output_feature_map_keys, output_feature_maps_list)))
