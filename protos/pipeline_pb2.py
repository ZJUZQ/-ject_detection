...
_TRAINEVALPIPELINECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='graph_rewriter', full_name='protos.TrainEvalPipelineConfig.graph_rewriter', index=5,
