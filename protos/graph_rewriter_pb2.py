...
_GRAPHREWRITER = _descriptor.Descriptor(
  name='GraphRewriter',
  full_name='protos.GraphRewriter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='quantization', full_name='protos.GraphRewriter.quantization', index=0,
...
_QUANTIZATION = _descriptor.Descriptor(
  name='Quantization',
  full_name='protos.Quantization',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='delay', full_name='protos.Quantization.delay', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weight_bits', full_name='protos.Quantization.weight_bits', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='activation_bits', full_name='protos.Quantization.activation_bits', index=2,
...
GraphRewriter = _reflection.GeneratedProtocolMessageType('GraphRewriter', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:protos.GraphRewriter)
  ))
...
Quantization = _reflection.GeneratedProtocolMessageType('Quantization', (_message.Message,), dict(
  ...
  __module__ = 'object_detection.protos.graph_rewriter_pb2'
  # @@protoc_insertion_point(class_scope:protos.Quantization)
  ))
