...
class BatcherTest(tf.test.TestCase):
	...
	def test_batch_and_unpad_2d_tensors_of_different_sizes_in_1st_dimension(self, verbose=False):
		print('\n==========================================================================')
		print('test_batch_and_unpad_2d_tensors_of_different_sizes_in_1st_dimension')
		...
		with self.test_session() as sess:
			...
			boxes = tf.tile(input=tf.reshape(tf.range(4), [1, 4]), 
							multiples=tf.stack([counter, tf.constant(1)]))
			if verbose:
	...
	def test_batch_and_unpad_2d_tensors_of_different_sizes_in_all_dimensions(self):
		print('\n=======================================================================')
		print('test_batch_and_unpad_2d_tensors_of_different_sizes_in_all_dimensions')
...
if __name__ == '__main__':
	#tf.test.main()
	BatcherTest().test_batch_and_unpad_2d_tensors_of_different_sizes_in_1st_dimension()

	BatcherTest().test_batch_and_unpad_2d_tensors_of_different_sizes_in_all_dimensions()
