...
class MobilenetV1Test(tf.test.TestCase):
	...
	def testBuildClassificationNetwork(self):
		print('\n==========================================================')
		print('testBuildClassificationNetwork')
		...
		for key in end_points.keys():
			print('{}: {}'.format(key, end_points[key].shape))
	...
	def testBuildBaseNetwork(self):
		print('\n====================================================')
		print('testBuildBaseNetwork')

		batch_size = 5
		height, width = 224, 224

		inputs = tf.random_uniform((batch_size, height, width, 3))
		net, end_points = mobilenet_v1.mobilenet_v1_base(inputs, scope='MobilenetV1_testBuildBaseNetwork')
		self.assertTrue(net.op.name.startswith('MobilenetV1_testBuildBaseNetwork/Conv2d_13'))
	...
	def testBuildOnlyUptoFinalEndpoint(self):
		print('\n=======================================================')
		print('testBuildOnlyUptoFinalEndpoint')
		...
		for index, endpoint in enumerate(endpoints):
			with tf.Graph().as_default():
				...
				out_tensor, end_points = mobilenet_v1.mobilenet_v1_base(
						inputs, final_endpoint=endpoint, scope='MobilenetV1_testBuildOnlyUptoFinalEndpoint')
				self.assertTrue(out_tensor.op.name.startswith(
								'MobilenetV1_testBuildOnlyUptoFinalEndpoint/' + endpoint))
				self.assertItemsEqual(endpoints[:index+1], end_points.keys())

	def testBuildCustomNetworkUsingConvDefs(self):
		batch_size = 5
		height, width = 224, 224
		conv_defs = [mobilenet_v1.Conv(kernel=[3, 3], stride=2, depth=32),
		...
		net, end_points = mobilenet_v1.mobilenet_v1_base(
				inputs, final_endpoint='Conv2d_3_pointwise', conv_defs=conv_defs, scope='MobilenetV1_')
...
if __name__ == '__main__':
	...
	#MobilenetV1Test().testBuildClassificationNetwork()

	MobilenetV1Test().testBuildBaseNetwork()
	MobilenetV1Test().testBuildOnlyUptoFinalEndpoint()
