...
def _update_optimizer_with_manual_step_learning_rate(optimizer, 
...
def _update_optimizer_with_cosine_decay_learning_rate(optimizer, 
                                                      learning_rate, 
...
class ConfigUtilTest(tf.test.TestCase):
  ...
  def test_create_configs_from_pipeline_proto(self):
    ...
    self.assertProtoEquals(pipeline_config.eval_input_reader, configs["eval_input_config"])

  def test_create_pipeline_proto_from_configs(self):
    """Tests that proto can be reconstructed from configs dictionary."""
    print('\n=========================================================================')
    print('test_create_pipeline_proto_from_configs')

    pipeline_config_path = os.path.join(self.get_temp_dir(), "pipeline.config")
    #pipeline_config_path = os.path.join('/home/zq/tmp/', "pipeline.config")
    print('pipeline_config_path: {}'.format(pipeline_config_path))
  ...
  def _assertOptimizerWithNewLearningRate(self, optimizer_name):
    ...
    print('\n==================================================================')
    print('_assertOptimizerWithNewLearningRate')
...
if __name__ == "__main__":
    #tf.test.main()
    ConfigUtilTest().test_create_configs_from_pipeline_proto()
    ConfigUtilTest().test_create_pipeline_proto_from_configs()
    ConfigUtilTest().test_save_pipeline_config()
    ConfigUtilTest().test_get_configs_from_multiple_files()

    ConfigUtilTest()._assertOptimizerWithNewLearningRate(optimizer_name='adam_optimizer')
