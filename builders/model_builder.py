...
def build(model_config, is_training, add_summaries=True,
	...
	meta_architecture = model_config.WhichOneof('model') # find out which field (if any) in the oneof has been set. 
	if meta_architecture == 'ssd':
		return _build_ssd_model(model_config.ssd, is_training, add_summaries, add_background_class)
	if meta_architecture == 'faster_rcnn':
		return _build_faster_rcnn_model(model_config.faster_rcnn, is_training, add_summaries)
